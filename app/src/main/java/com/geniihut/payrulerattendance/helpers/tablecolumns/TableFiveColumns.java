...
public class TableFiveColumns {
    ...
    @InjectView(R.id.tvHeader5)
    protected TextView mTvHeader5;

    private static final int RES_LAYOUT = R.layout.table_four_columns;

    public TableFiveColumns(View view) {
    ...
    public void setHeaderTitles(String title1, String title2, String title3, String title4, String title5) {
        mTvHeader1.setText(title1);
        mTvHeader2.setText(title2);
        mTvHeader3.setText(title3);
        mTvHeader4.setText(title4);
        mTvHeader5.setText(title5);
    }
}
